		...
		<>
			...
			>
				...
				>
					<BrowserRouter>
						{' '}
						<NavBar chatViewActive={chatViewActive} isLoggedIn={isLoggedIn} />
						<Routes>
							<Route
								path='/'
								element={
...
function NavBar({ isLoggedIn, chatViewActive }) {
	...
	useEffect(() => {
		const urlList = ['/dashboard', '/chat', '/profile'];
						...
						>
							...
							>
								<BottomNavigationAction
									...
									component={Link}
									to='/dashboard'
									icon={<HomeRoundedIcon sx={{ opacity: 0.3, mb: 0.5 }} />}
								/>
								<BottomNavigationAction
									disableRipple
									sx={{
									...
									component={Link}
									to='/chat'
									icon={<ChatRounded sx={{ opacity: 0.3, mb: 0.5 }} />}
								/>
								{/* 
                                    <BottomNavigationAction
                                        disableRipple
